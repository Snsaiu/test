...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c1aad66f-dfdf-4cfc-b9cc-8ae8663bbd85
```

> `c1aad66f-dfdf-4cfc-b9cc-8ae8663bbd85` is the password of the certificate, you can change it to any password you want.
